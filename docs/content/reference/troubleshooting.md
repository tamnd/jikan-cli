...
Most of these come down to network reality or how jikan serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

jikan rate-limits like any public site. jikan already paces
...
Where a surface is gated, jikan reads a cookie or token you supply
...
`jikan`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what jikan actually did
