...
// HTTP behaviour is covered in jikan_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "jikan://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("jikan", "about")
	if err != nil || got.String() != "jikan://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want jikan://page/about", got.String(), err)
	}
}
